...
export const metadata: Metadata = {
  title:
    "Gem & Jewellery Services: Cutting, Certification, Appraisal | Lumevelo",
  description:
    "Find gem cutting, polishing, certification, appraisal, and jewellery repair services from trusted professionals worldwide.",
};
...
export default async function ServicesPage({ searchParams }: Props) {
  ...
  const pageHref = (p: number) => `/services?page=${p}${q ? `&q=${q}` : ""}`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            ...
            repair from trusted experts worldwide.
          </p>
        </div>
